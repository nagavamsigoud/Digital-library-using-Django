...
** Features**
For CustomersBook Discovery: Browse a dynamic list of available books organized by categories.
...
Use the requirements.txt file we created to install all necessary libraries at once.

pip install -r requirements.txt

**3. Database Configuration**
Before running the server, you must set up the database schema using Django's migration system.

**Prepare Migrations:**

python manage.py makemigrations

**Apply Migrations:** This creates the actual tables in your SQLite3 database.
...
**Access the Store**: Open your browser and go to http://127.0.0.1:8000/.

**Access Admin Panel**: Go to http://127.0.0.1:8000/admin/.

**Note**: To log in here, you may need to create a superuser first by running python manage.py createsuperuser.
